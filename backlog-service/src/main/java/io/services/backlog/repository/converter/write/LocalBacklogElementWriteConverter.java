...
@Component
@WritingConverter
public class LocalBacklogElementWriteConverter implements Converter<LocalBacklogElement, OutboundRow> {

    @Override
    public OutboundRow convert(LocalBacklogElement backlogElement) {
        ImmutableMap<String, Parameter> map = ImmutableMap.<String, Parameter>builder()
                ...
                .put(COLUMN_CONTENT, Parameter.from(backlogElement.getContent()))
